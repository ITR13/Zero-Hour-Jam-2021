...
public class BoxMaster : MonoBehaviour
{
    ...
    private readonly string[] _levels = new[]
    {
        ...
        "0:1;4:1;-1:-1;1:0;3:1;1:3;2:1;-1:-2;-2:-1;0:3;1:4;1:2;3:0;2:3;3:2", // XX
        "-1:3;-2:2;1:4;2:1;3:2", // Test
        "3:-2;3:2;4:0;-1:0;2:-3;2:3", // >
        "0:4;0:-1;2:0;1:0;4:0;0:2;-1:0;-4:0;0:1;0:-2;0:-4;-2:0", // +
    };
